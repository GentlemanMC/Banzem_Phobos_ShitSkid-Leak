...
public class Banzem {
    ...
    public static final Logger LOGGER = LogManager.getLogger((String)"banzem");
    ...
    public static void onUnload() {
        if (!unloaded) {
            ...
            configManager.saveConfig(Banzem.configManager.config.replaceFirst("banzem/", ""));
