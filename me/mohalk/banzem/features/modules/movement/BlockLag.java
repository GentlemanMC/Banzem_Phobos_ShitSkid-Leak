...
extends Module {
    ...
    public BlockLag() {
        super("BlockLag", "TPs you into a block", Module.Category.MOVEMENT, true, false, false);
    }
    ...
    public void onEnable() {
        ...
        if (BlockLag.mc.field_71441_e.func_180495_p(new BlockPos(BlockLag.mc.field_71439_g.field_70165_t, BlockLag.mc.field_71439_g.field_70163_u, BlockLag.mc.field_71439_g.field_70161_v)).func_177230_c().equals((Object)this.returnBlock) || this.intersectsWithEntity(this.originalPos)) {
            this.toggle();
            return;
        }
