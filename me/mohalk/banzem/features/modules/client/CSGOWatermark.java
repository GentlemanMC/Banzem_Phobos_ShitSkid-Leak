...
extends Module {
    ...
    public CSGOWatermark() {
        super("CSGOWatermark", "mohalk actually makes something", Module.Category.CLIENT, true, false, false);
    }
    ...
    public void drawCsgoWatermark() {
        int padding = 5;
        this.message = "Banzem 1.0.0 | " + CSGOWatermark.mc.field_71439_g.func_70005_c_() + " | " + Banzem.serverManager.getPing() + "ms";
