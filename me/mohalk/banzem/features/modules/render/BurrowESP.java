...
extends Module {
    ...
    public BurrowESP() {
        super("BurrowESP", "Shows burrowed people.", Module.Category.RENDER, true, false, false);
    ...
    private void getPlayers() {
        for (EntityPlayer entityPlayer : BurrowESP.mc.field_71441_e.field_73010_i) {
            if (entityPlayer == BurrowESP.mc.field_71439_g || Banzem.friendManager.isFriend(entityPlayer.func_70005_c_()) || !EntityUtil.isLiving((Entity)entityPlayer) || !this.isBurrowed(entityPlayer)) continue;
