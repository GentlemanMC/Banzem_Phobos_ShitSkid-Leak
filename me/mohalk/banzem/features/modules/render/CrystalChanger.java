...
extends Module {
    ...
    public void onUpdate() {
        for (Entity crystal : CrystalChanger.mc.field_71441_e.field_72996_f) {
    ...
    public void onReceivePacket(PacketEvent.Receive event) {
        if (event.getPacket() instanceof SPacketDestroyEntities) {
            ...
            for (int id : packet.func_149098_c()) {
                Entity entity = CrystalChanger.mc.field_71441_e.func_73045_a(id);
    ...
    public void onRenderModel(RenderEntityModelEvent event) {
        ...
        boolean fancyGraphics = CrystalChanger.mc.field_71474_y.field_74347_j;
        CrystalChanger.mc.field_71474_y.field_74347_j = false;
        float gamma = CrystalChanger.mc.field_71474_y.field_74333_Y;
