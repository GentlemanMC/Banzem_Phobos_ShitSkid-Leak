...
extends Module {
    ...
    public FakePlayer() {
        super("FakePlayer", "Spawns fake player", Module.Category.MISC, false, false, false);
        this.setInstance();
    }
    ...
    public void addFakePlayer(int entityId) {
        if (this.otherPlayer == null) {
            this.otherPlayer = new EntityOtherPlayerMP((World)FakePlayer.mc.field_71441_e, new GameProfile(UUID.randomUUID(), "212_"));
