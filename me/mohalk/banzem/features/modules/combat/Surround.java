...
extends Module {
    ...
    private void doFeetPlace() {
        ...
        if (!OyVeyentityUtil.isSafe((Entity)Surround.mc.field_71439_g, 0, true)) {
            ...
            this.isSafe = 3;
            if (Util.mc.field_71441_e.func_180495_p(EntityUtil.getRoundedBlockPos((Entity)Util.mc.field_71439_g)).func_177230_c().equals((Object)Blocks.field_150477_bB) && Util.mc.field_71439_g.field_70163_u != (double)EntityUtil.getRoundedBlockPos((Entity)Util.mc.field_71439_g).func_177956_o()) {
                this.placeBlocks(Surround.mc.field_71439_g.func_174791_d(), OyVeyentityUtil.getUnsafeBlockArray((Entity)Surround.mc.field_71439_g, 1, false), false, false, true);
            } else {
                this.isSafe = 4;
            }
