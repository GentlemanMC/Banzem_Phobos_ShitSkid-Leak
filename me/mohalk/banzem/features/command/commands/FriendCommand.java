            ...
            switch (commands[0]) {
                case "add": {
                    ...
                    if (FriendSettings.getInstance().notify.getValue().booleanValue()) {
                        Util.mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketChatMessage("/w " + commands[1] + " I just added you to my friends list on Banzem Client!"));
                    }
                    return;
                }
                case "del": {
                    ...
                    if (FriendSettings.getInstance().notify.getValue().booleanValue()) {
                        Util.mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketChatMessage("/w " + commands[1] + " I just removed you from my friends list on Banzem Client!"));
                    }
