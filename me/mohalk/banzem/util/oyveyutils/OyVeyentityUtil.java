...
implements Util {
    ...
    public static Map<String, Integer> getTextRadarPlayers() {
        ...
        for (EntityPlayer player : OyVeyentityUtil.mc.field_71441_e.field_73010_i) {
            ...
            output.put(healthSB.toString() + " " + (Object)(Banzem.friendManager.isFriend(player) ? ChatFormatting.AQUA : ChatFormatting.RED) + player.func_70005_c_() + " " + distanceSB.toString() + " \u00c2\u00a7f0", (int)OyVeyentityUtil.mc.field_71439_g.func_70032_d((Entity)player));
