...
public class EntityUtil implements Util
{
    ...
    public static List<EntityPlayer> getNearbyPlayers(final double d) {
        ...
        list.removeIf(entityPlayer -> Banzem.friendManager.isFriend(entityPlayer.getName()));
        return list;
    }
    ...
    public static boolean isntValid(final Entity entity, final double range) {
        return entity == null || isDead(entity) || entity.equals((Object)EntityUtil.mc.player) || (entity instanceof EntityPlayer && Banzem.friendManager.isFriend(entity.getName())) || EntityUtil.mc.player.getDistanceSq(entity) > MathUtil.square(range);
    }
    ...
    public static Color getColor(final Entity entity, final int red, final int green, final int blue, final int alpha, final boolean colorFriends) {
        ...
        if (entity instanceof EntityPlayer) {
            ...
            final Killaura killaura = Banzem.moduleManager.getModuleByClass(Killaura.class);
    ...
    public static Map<String, Integer> getTextRadarPlayers() {
        ...
        for (final EntityPlayer player : EntityUtil.mc.world.playerEntities) {
            ...
            output.put((Object)healthSB + " " + (Banzem.friendManager.isFriend(player) ? "§b" : "§r") + player.getName() + " " + (Object)distanceSB + " §f" + Banzem.totemPopManager.getTotemPopString(player) + Banzem.potionManager.getTextRadarPotion(player), (int)EntityUtil.mc.player.getDistance((Entity)player));
