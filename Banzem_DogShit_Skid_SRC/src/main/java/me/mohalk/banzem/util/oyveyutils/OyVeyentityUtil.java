...
public class OyVeyentityUtil implements Util
{
    ...
    public static boolean isntValid(final Entity entity, final double range) {
        return entity == null || isDead(entity) || entity.equals((Object)OyVeyentityUtil.mc.player) || (entity instanceof EntityPlayer && Banzem.friendManager.isFriend(entity.getName())) || OyVeyentityUtil.mc.player.getDistanceSq(entity) > MathUtil.square(range);
    }
    ...
    public static Map<String, Integer> getTextRadarPlayers() {
        ...
        for (final EntityPlayer player : OyVeyentityUtil.mc.world.playerEntities) {
            if (!player.isInvisible()) {
                ...
                output.put(healthSB.toString() + " " + (Banzem.friendManager.isFriend(player) ? ChatFormatting.AQUA : ChatFormatting.RED) + player.getName() + " " + distanceSB.toString() + " \u00c2§f0", (int)OyVeyentityUtil.mc.player.getDistance((Entity)player));
