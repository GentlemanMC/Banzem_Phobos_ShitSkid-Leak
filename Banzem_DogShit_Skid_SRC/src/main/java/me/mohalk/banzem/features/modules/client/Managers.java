...
public class Managers extends Module
{
    ...
    public Managers() {
        ...
        this.command = (Setting<String>)this.register(new Setting("Command", "Banzem"));
        this.rainbowPrefix = (Setting<Boolean>)this.register(new Setting("RainbowPrefix", false));
        this.bracketColor = (Setting<TextUtil.Color>)this.register(new Setting("BColor", TextUtil.Color.DARK_PURPLE));
        this.commandColor = (Setting<TextUtil.Color>)this.register(new Setting("CColor", TextUtil.Color.DARK_PURPLE));
