...
public class Strafe extends Module
{
    ...
    public void onMove(final MoveEvent event) {
        ...
        if (this.mode.getValue() == Mode.NCP) {
            ...
            if (this.limiter2.getValue() && Strafe.mc.player.onGround && Banzem.speedManager.getSpeedKpH() < this.speedLimit2.getValue()) {
                this.stage = 2;
            }
            ...
            if (this.stage == 1 && EntityUtil.isMoving()) {
                ...
                if (Strafe.mc.world.getCollisionBoxes((Entity)Strafe.mc.player, Strafe.mc.player.getEntityBoundingBox().offset(0.0, Strafe.mc.player.motionY, 0.0)).size() > 0 || (Strafe.mc.player.collidedVertically && this.stage > 0)) {
                    this.stage = (((!this.bhop2.getValue() || Banzem.speedManager.getSpeedKpH() < this.speedLimit.getValue()) && (Strafe.mc.player.moveForward != 0.0f || Strafe.mc.player.moveStrafing != 0.0f)) ? 1 : 0);
                }
