...
public class ClickGui extends Module
{
    ...
    public ClickGui() {
        ...
        this.green = (Setting<Integer>)this.register(new Setting("Green", 3, 0, 255));
        this.blue = (Setting<Integer>)this.register(new Setting("Blue", 255, 0, 255));
        this.hoverAlpha = (Setting<Integer>)this.register(new Setting("Alpha", 64, 0, 255));
        this.alpha = (Setting<Integer>)this.register(new Setting("HoverAlpha", 180, 0, 255));
        ...
        this.devSettings = (Setting<Boolean>)this.register(new Setting("DevSettings", true));
        ...
        this.topAlpha = (Setting<Integer>)this.register(new Setting("TopAlpha", 30, 0, 255, v -> this.devSettings.getValue()));
        this.blurEffect = (Setting<Boolean>)this.register(new Setting("Blur", true));
        this.setInstance();
    }
