...
public class HoleFiller extends Module
{
    ...
    private void doHoleFill() {
        ...
        if (this.midSafeHoles.getValue()) {
            final Object object = Banzem.holeManager.getMidSafety();
            synchronized (object) {
                final ArrayList<BlockPos> targets = new ArrayList<BlockPos>(Banzem.holeManager.getMidSafety());
            }
        }
        final Object object = Banzem.holeManager.getHoles();
