...
public class GodModule extends Module
{
    ...
    public GodModule() {
        ...
        this.antiIllegal = (Setting<Boolean>)this.register(new Setting("AntiIllegal", true));
        this.checkPos = (Setting<Boolean>)this.register(new Setting("CheckPos", true));
        this.oneDot15 = (Setting<Boolean>)this.register(new Setting("1.15", false));
        this.entitycheck = (Setting<Boolean>)this.register(new Setting("EntityCheck", false));
        this.attacks = (Setting<Integer>)this.register(new Setting("Attacks", 1, 1, 10));
        this.delay = (Setting<Integer>)this.register(new Setting("Delay", 0, 0, 50));
        this.yaw = 0.0f;
        this.pitch = 0.0f;
