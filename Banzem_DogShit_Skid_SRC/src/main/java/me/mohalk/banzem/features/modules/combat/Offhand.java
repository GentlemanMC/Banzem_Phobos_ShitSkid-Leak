...
public class Offhand extends Module
{
    ...
    private boolean noNearbyPlayers() {
        return this.mode == Mode.CRYSTALS && Offhand.mc.world.playerEntities.stream().noneMatch(e -> e != Offhand.mc.player && !Banzem.friendManager.isFriend(e) && Offhand.mc.player.getDistance((Entity)e) <= this.cTargetDistance.getValue());
    }
