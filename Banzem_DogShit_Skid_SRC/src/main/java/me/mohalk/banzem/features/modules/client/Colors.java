...
public class Colors extends Module
{
    ...
    public void onTick() {
        ...
        if (ClickGui.getInstance().colorSync.getValue()) {
            Banzem.colorManager.setColor(Colors.INSTANCE.getCurrentColor().getRed(), Colors.INSTANCE.getCurrentColor().getGreen(), Colors.INSTANCE.getCurrentColor().getBlue(), ClickGui.getInstance().hoverAlpha.getValue());
        }
    }
