...
public class HoleESP extends Module
{
    ...
    public HoleESP() {
        ...
        this.gradientBox = (Setting<Boolean>)this.register(new Setting("GradientBox", Boolean.FALSE, v -> this.box.getValue()));
        this.pulseAlpha = (Setting<Boolean>)this.register(new Setting("PulseAlpha", Boolean.FALSE, v -> this.gradientBox.getValue()));
        ...
        this.invertGradientBox = (Setting<Boolean>)this.register(new Setting("InvertGradientBox", Boolean.FALSE, v -> this.gradientBox.getValue()));
        ...
        this.gradientOutline = (Setting<Boolean>)this.register(new Setting("GradientOutline", Boolean.FALSE, v -> this.outline.getValue()));
        this.invertGradientOutline = (Setting<Boolean>)this.register(new Setting("InvertGradientOutline", Boolean.FALSE, v -> this.gradientOutline.getValue()));
        ...
        this.customOutline = (Setting<Boolean>)this.register(new Setting("CustomLine", Boolean.FALSE, v -> this.outline.getValue()));
    ...
    public void onRender3D(final Render3DEvent event) {
        ...
        for (final BlockPos pos : Banzem.holeManager.getSortedHoles()) {
            ...
            if (this.safeColor.getValue() && Banzem.holeManager.isSafe(pos)) {
